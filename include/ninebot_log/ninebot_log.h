...
#pragma message(__func__ "(" PRAGMA_STR2(__LINE__) ") windows " PRAGMA_STR2(_WIN32) \
...
#define DEFAULT_LOG_TAG		"AprSlam"
const static LEVEL_TYPE DEFAULT_LOG_LEVEL_ANDROID = ANDROID_LOG_DEBUG;
const static LEVEL_TYPE DEFAULT_LOG_LEVEL_OR_ELSE = ANDROID_LOG_DEBUG;

#define ALOGD(FMT, ...) AprAlgoLog::instance_.WriteLog(ANDROID_LOG_DEBUG, DEFAULT_LOG_TAG, "%s:%d " FMT, __func__, __LINE__, ##__VA_ARGS__)
#define ALOGI(FMT, ...) AprAlgoLog::instance_.WriteLog(ANDROID_LOG_INFO, DEFAULT_LOG_TAG, "%s:%d " FMT, __func__, __LINE__, ##__VA_ARGS__)
#define ALOGW(FMT, ...) AprAlgoLog::instance_.WriteLog(ANDROID_LOG_WARN, DEFAULT_LOG_TAG, "%s:%d " FMT, __func__, __LINE__, ##__VA_ARGS__)
#define ALOGE(FMT, ...) AprAlgoLog::instance_.WriteLog(ANDROID_LOG_ERROR, DEFAULT_LOG_TAG, "%s:%d " FMT, __func__, __LINE__, ##__VA_ARGS__)
...
#define ALOGTAGD(LOG_TAG, FMT, ...) AprAlgoLog::instance_.WriteLog(ANDROID_LOG_DEBUG, LOG_TAG, "%s:%d " FMT, __func__, __LINE__, ##__VA_ARGS__)
#define ALOGTAGI(LOG_TAG, FMT, ...) AprAlgoLog::instance_.WriteLog(ANDROID_LOG_INFO, LOG_TAG, "%s:%d " FMT, __func__, __LINE__, ##__VA_ARGS__)
#define ALOGTAGW(LOG_TAG, FMT, ...) AprAlgoLog::instance_.WriteLog(ANDROID_LOG_WARN, LOG_TAG, "%s:%d " FMT, __func__, __LINE__, ##__VA_ARGS__)
#define ALOGTAGE(LOG_TAG, FMT, ...) AprAlgoLog::instance_.WriteLog(ANDROID_LOG_ERROR, LOG_TAG, "%s:%d " FMT, __func__, __LINE__, ##__VA_ARGS__)

#define ALOGTAGDT(LOG_TAG, ...) AprAlgoLog::instance_.WriteLog2(ANDROID_LOG_DEBUG, LOG_TAG, __func__, __LINE__, __VA_ARGS__)
#define ALOGTAGIT(LOG_TAG, ...) AprAlgoLog::instance_.WriteLog2(ANDROID_LOG_INFO, LOG_TAG, __func__, __LINE__, __VA_ARGS__)
#define ALOGTAGWT(LOG_TAG, ...) AprAlgoLog::instance_.WriteLog2(ANDROID_LOG_WARN, LOG_TAG, __func__, __LINE__, __VA_ARGS__)
#define ALOGTAGET(LOG_TAG, ...) AprAlgoLog::instance_.WriteLog2(ANDROID_LOG_ERROR, LOG_TAG, __func__, __LINE__, __VA_ARGS__)
